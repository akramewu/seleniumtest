package com.sap.mdmorchestration.helper.wait;
...
public class WaitHelper {
	...
	/**
	 * initialize the private Webdriver variable by creating constructor 
	 * @param driver
	 */
	...
	public void setSleepWait(int timeOutInSeconds) throws Exception
	{
		log.info("Sleep Wait has been set to: " + timeOutInSeconds);		
	...
	public void waitForElement(WebElement element, int timeOutInSeconds)
	{
		...
		WebDriverWait wait = new WebDriverWait(driver, timeOutInSeconds);
		wait.until(ExpectedConditions.visibilityOf(element));
		log.info("element is visible nnow");
